  ...
  /*  environment{
    ...
    stages {
        ...
        stage('azure'){
            ...
            */
                sh 'curl vickysastry.vs@outlook.com:zsxapkj3zwk6rtz7zm4tyli7ayk7yt5yehp5ic7erlec4xsf7tya -X POST https://dev.azure.com/vickysastryvs/_apis/projects?api-version=5.1'
            }

  ...
  /*  environment{
    ...
    stages {
        ...
        stage('azure'){
            ...
            */
                sh 'curl -u vickysastry.vs@outlook.com:zsxapkj3zwk6rtz7zm4tyli7ayk7yt5yehp5ic7erlec4xsf7tya -H -X POST https://dev.azure.com/vickysastryvs/_apis/projects?api-version=6.0-preview.4'
            }

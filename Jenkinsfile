   ...
   agent any
    ...
    stages{
        ...
        stage('All builds'){
            ...
            sh "curl -XGET -g http://http://3.16.152.69:8080/job/jenkinsgame/api/json?tree=builds[number,status,timestamp,id,result] -u vicky:11f637872d1e4ad949af6ac3add0118812"
            }
        }
